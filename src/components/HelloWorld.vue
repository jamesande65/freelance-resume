<template>
  ...
  <nav
    id="mainNav"
    class="navbar navbar-default navbar-fixed-top navbar-custom affix-top"
  >
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="intro-text">
            ...
            <hr class="star-light" />
            <span class="skills">Web Developer - Frontend Development</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="footer-col col-md-12">
            <h3>About Us</h3>
            <p>
              Freelance web developers that take pride in making websites and
